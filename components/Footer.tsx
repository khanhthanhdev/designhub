    ...
    <footer className="flexStart footer">
        <div className="flex flex-col gap-12 w-full">
            <div className="flex items-start flex-col">
                ...
                <p className="text-start text-sm font-normal ml-5 max-w-xs">
                    Flexibble is a community of designers and developers who give feedback on each other's work
                </p>
            </div>
        ...
        <div className="flexBetween footer_copyright">
            ...
            <p className='text-gray'>
                <span className='text-black font-semibold'>2705 </span>
                Projects shared
            </p>
        </div>
    </footer>
